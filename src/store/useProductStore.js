...
const useProductStore = create((set) => ({
    products : [
      ...
      },
      {
        ...
        price: 599,
        description: "21. 5 inches Full HD (1920 x 1080) widescreen IPS display And 75Hz refresh rate Ultra-thin design with zero-frame technology",
        category: "electronics",
      ...
      },
      {
        ...
        price: 999.99,
        description: "Samsung 49-Inch CHG90 144Hz Curved Gaming Monitor (LC49HG90DMNXZA) - 49 inches super ultrawide with Quantum Dot technology and a 144Hz refresh rate.",
        category: "electronics",
      ...
      },
      {
        ...
        price: 56.99,
        description: "3-in-1 Snowboard Jacket, Detachable Design, Adjustable Hood and Cuffs, Suitable for Various Weather Conditions, Lightweight and Warm",
      ...
      },
      {
        ...
        price: 29.95,
        description: "Faux Leather Moto Biker Jacket with Removable Hood, Two Front Pockets, and Button Details on Waist",
        category: "women's clothing",
      ...
      },
      {
        ...
        price: 39.99,
        description: "Lightweight Raincoat with Adjustable Hood and Waist, Button and Zipper Front Closure",
        category: "women's clothing",
      ...
      },
      {
        ...
        price: 9.85,
        description: "Lightweight Fabric with a Comfortable Fit, Ribbed Sleeves and Neckline",
        category: "women's clothing",
      ...
      },
      {
        ...
        price: 7.95,
        description: "Moisture-Wicking Polyester V-Neck Shirt with Sleek, Feminine Silhouette",
        category: "women's clothing",
      ...
      },
      {
        ...
        price: 12.99,
        description: "Casual, Short Sleeve V-Neck T-Shirt Made from Soft, Stretchy Fabric",
        category: "women's clothing",
